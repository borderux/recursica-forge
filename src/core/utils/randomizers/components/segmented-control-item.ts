...
export function randomizeSegmentedControlItem(componentNode: any, options: any, diffs: any[], pathPrefix: string): void {
    ...
    function isPathSelected(pathArr: string[]): boolean {
        ...
        const fullPathArr = ['segmented-control-item', ...pathArr];
