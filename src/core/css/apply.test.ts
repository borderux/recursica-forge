...
describe('applyCssVars', () => {
  ...
  it('should apply valid CSS variables', () => {
    const vars = {
      ...
      '--recursica_brand_modes_light_palettes_core-colors_high-contrast': 'var(--recursica_tokens_color_gray_1000)'
    }
    ...
    expect(document.documentElement.style.getPropertyValue('--recursica_brand_modes_light_palettes_core-colors_high-contrast')).toBe('var(--recursica_tokens_color_gray_1000)')
  })

  it('should reject brand vars with hardcoded hex values', () => {
    const vars = {
      '--recursica_brand_modes_light_palettes_core-colors_high-contrast': '#000000'
    }
