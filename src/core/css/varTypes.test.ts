...
describe('isTokenVar', () => {
  ...
  it('should return false for brand vars', () => {
    expect(isTokenVar('--recursica_brand_modes_light_palettes_core-colors_high-contrast')).toBe(false)
  })
...
describe('isBrandVar', () => {
  it('should return true for recursica-brand- prefix', () => {
    expect(isBrandVar('--recursica_brand_modes_light_palettes_core-colors_high-contrast')).toBe(true)
  })
