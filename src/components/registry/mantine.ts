...
registerComponent('mantine', 'TabsList', () => import('../adapters/mantine/Tabs/TabsList'))
registerComponent('mantine', 'TabsTab', () => import('../adapters/mantine/Tabs/TabsTab'))
registerComponent('mantine', 'TabsPanel', () => import('../adapters/mantine/Tabs/TabsPanel'))
