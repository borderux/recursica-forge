...
export default function CheckboxItem({
    ...
    const cssVars = {
        ...
        '--checkbox-disabled-bg-checked': getColorVar('disabled-background-checked-color'),
        '--checkbox-disabled-bg-unchecked': getColorVar('disabled-background-unchecked-color'),
        '--checkbox-disabled-bg-indeterminate': getColorVar('disabled-background-indeterminate-color'),
