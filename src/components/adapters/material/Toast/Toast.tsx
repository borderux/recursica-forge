/**
 * Material UI Toast Implementation
 * 
 * Material UI-specific Toast component that uses CSS variables for theming.
...
export default React.forwardRef<any, AdapterToastProps>(function Toast({
  ...
  return (
    <Paper {...materialProps} style={style} ref={ref}>
