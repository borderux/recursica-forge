...
describe.skip('Button CSS Variables', () => {
  ...
  describe('CSS Variable Fallbacks', () => {
    it('handles missing CSS variables gracefully', async () => {
      ...
      await act(async () => {
        document.documentElement.style.removeProperty('--recursica_ui-kit_components_button_color_layer-0_variant_solid_background')
      })
  ...
  describe('CSS Variable Namespace', () => {
    it('all CSS variables use --recursica_* namespace', async () => {
