...
export default React.forwardRef<any, AdapterTextFieldProps & { labelId?: string; helpId?: string; errorId?: string }>(function TextField({
  ...
  if (layout === 'side-by-side' && labelElement) {
    ...
    return (
      <div className={`recursica-text-field recursica-text-field-side-by-side ${className || ''}`} style={style} ref={ref}>
  ...
  return (
    <div className={`recursica-text-field recursica-text-field-stacked ${className || ''}`} style={style} ref={ref}>
