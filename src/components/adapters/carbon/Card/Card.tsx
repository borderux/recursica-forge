/**
 * Carbon Card Implementation
 * 
 * Uses a styled div as the foundation since Carbon doesn't have a dedicated Card component.
            ...
            {title && (
                ...
                >
                    <span style={{
                        ...
                        textDecoration: 'none',
                        textTransform: `var(--recursica-brand-typography-${headerStyleValue}-text-transform)` as any,
                        display: 'block',
                        overflow: 'clip',
            ...
            {footer && (
                <div
                    ...
                    style={{
                        ...
                        borderTop: withDividers ? 'var(--card-divider-size) solid var(--card-divider-color)' : 'none',
                    }}
                >
                    {footer}
                </div>
