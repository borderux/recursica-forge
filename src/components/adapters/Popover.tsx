...
// Re-exported so existing `import type { PopoverProps } from '.../adapters/Popover'`
// call sites keep working — the types now live in common/Popover.ts.
...
export function Popover({
    ...
    const Component = useComponent('Popover')
