/**
 * TextField — common types
 *
 * Single source of truth for the TextField prop vocabulary, shared by the dispatcher
 * (`adapters/TextField.tsx`) and every per-library wrapper (`adapters/{mantine,material,carbon}/TextField`).
 */
