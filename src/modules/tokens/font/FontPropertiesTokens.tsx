        ...
        <div style={{ display: 'flex', gap: 'var(--recursica-brand-dimensions-general-default)', paddingTop: 'var(--recursica-brand-dimensions-gutters-vertical)', paddingBottom: 'var(--recursica-brand-dimensions-gutters-vertical)', paddingLeft: 'var(--recursica-brand-dimensions-gutters-horizontal)', paddingRight: 'var(--recursica-brand-dimensions-gutters-horizontal)', alignItems: 'center' }}>
          <button
            ...
            style={{
              ...
              fontWeight: activeTab === 'size' ? 600 : 'var(--recursica-brand-typography-body-font-weight)',
          ...
          <button
            ...
            style={{
              ...
              fontWeight: activeTab === 'letter-spacing' ? 600 : 'var(--recursica-brand-typography-body-font-weight)',
              fontSize: 'var(--recursica-brand-typography-body-font-size)',
              borderRadius: `var(${buttonBorderRadius})`,
              cursor: 'pointer',
              transition: 'all 0.2s',
          ...
          <button
            ...
            style={{
              ...
              fontWeight: activeTab === 'line-height' ? 600 : 'var(--recursica-brand-typography-body-font-weight)',
              fontSize: 'var(--recursica-brand-typography-body-font-size)',
              borderRadius: `var(${buttonBorderRadius})`,
              cursor: 'pointer',
              transition: 'all 0.2s',
