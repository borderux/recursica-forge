...
export default function FontWeightTokens() {
  ...
  return (
    <section style={{ background: 'var(--recursica_brand_layer_0_properties_surface)', border: '1px solid var(--recursica_brand_layer_1_properties_border-color)', borderRadius: 8, padding: 12 }}>
