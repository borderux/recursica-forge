  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <Modal
          isOpen={isDialogOpen}
          onClose={() => { setIsDialogOpen(false); clearSelectedFiles(); setSelectedFileNames([]); setUploadedFiles([]) }}
          title="Import"
          layer="layer-1"
          primaryActionLabel="Import"
          onPrimaryAction={handleImportClick}
          primaryActionDisabled={selectedFileNames.length === 0}
          onSecondaryAction={() => { setIsDialogOpen(false); clearSelectedFiles(); setSelectedFileNames([]); setUploadedFiles([]) }}
          content={
