  ...
  return (
    <Theme theme="g10">
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <Modal
          isOpen={isOpen}
          onClose={() => { setIsOpen(false); clearSelectedFiles(); setSelectedFileNames([]); setUploadedFiles([]) }}
          title="Import"
          layer="layer-1"
          primaryActionLabel="Import"
          onPrimaryAction={handleImportClick}
          primaryActionDisabled={selectedFileNames.length === 0}
          onSecondaryAction={() => { setIsOpen(false); clearSelectedFiles(); setSelectedFileNames([]); setUploadedFiles([]) }}
          content={
