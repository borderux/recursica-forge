    ...
    >
      ...
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        ...
        <button
          ...
          style={{ border: `1px solid var(--recursica-brand-themes-${mode}-layer-layer-3-property-border-color, rgba(0,0,0,0.1))`, background: 'transparent', cursor: 'pointer', borderRadius: 6, padding: '6px 8px' }}
        >🏷️</button>
      </div>
